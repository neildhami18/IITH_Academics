...
wp_dest=LocationGlobalRelative(lat,lon,takeoff_height)

distance_between_home_and_destination=get_distance_meters(wp_dest,wp_home)
print("Dropoff is "+str(distance_between_home_and_destination)+" meters from home wp.")

############FLY DRONE TO DESTINATION############
