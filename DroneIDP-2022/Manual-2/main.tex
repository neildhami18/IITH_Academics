...
\begin{figure}
\label{fig1}
\includegraphics[width=1.0\columnwidth]{./figs/iir/epsilons.eps}
...
\begin{figure}
\label{fig2}
\includegraphics[width=1.0\columnwidth]{./figs/iir/lpanalog_cheb.eps}
...
\begin{figure}
\label{fig3}
\includegraphics[width=1.0\columnwidth]{./figs/iir/AnalogBandpass.eps}
...
\begin{figure}
\label{fig4}
\includegraphics[width=1.0\columnwidth]{./figs/iir/DigitalBandpass.eps}
...
\begin{figure}
\label{fig5}
\includegraphics[width=1.0\columnwidth]{./figs/fir/lowpass.eps}
