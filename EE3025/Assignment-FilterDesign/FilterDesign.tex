...
\title{\vspace{-2.0cm}EE3025 Assignment 2\\Digital Filter Design}
...
\begin{verbatim}
https://github.com/neildhami18/IITH_Academics/EE3025/Assignment-FilterDesign/codes
\end{verbatim}
...
%
\begin{verbatim}
https://github.com/neildhami18/IITH_Academics/EE3025/Assignment-FilterDesign
\end{verbatim}
...
\begin{figure}
\label{fig1}
\includegraphics[width = 15cm]{./figs/iir/epsilons.eps}
...
\begin{figure}
\label{fig2}
\includegraphics[width = 15cm]{./figs/iir/lpanalog_cheb.eps}
...
\begin{figure}
\label{fig3}
\includegraphics[width =15cm]{./figs/iir/AnalogBandpass.eps}
...
\begin{figure}
\label{fig4}
\includegraphics[width = 15cm]{./figs/iir/DigitalBandpass.eps}
